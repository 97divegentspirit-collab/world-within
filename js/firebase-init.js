...
// Note: image uploads for Scene 3 are handled by cloudinary-init.js
// (window.uploadJourneyImages), not Firebase Storage — this file
// only handles Firestore, which holds the actual submitted data.
